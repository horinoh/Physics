...
#else
//!< SAP (Sweep And Prune)
void Scene::BroadPhase(const float DeltaSec, std::vector<CollidablePair>& CollidablePairs)
{
...
void Scene::NarrowPhase(const float DeltaSec, const std::vector<CollidablePair>& CollidablePairs, std::vector<Contact>& Contacts)
{
...
void Scene::Update(const float DeltaSec)
{
	//!< 重力
